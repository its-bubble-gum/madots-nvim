return {
  ...
  config = function()
    ...
    vim.keymap.set("n", "<leader>dnR", dotnet.run_with_profile, { desc = "[D]ot[n]et [R]un with profile" })
    ...
    vim.keymap.set("n", "<leader>dnp", dotnet.pick, { desc = "[D]ot[n]et [P]ick project" })
    ...
    vim.keymap.set("n", "<leader>dnd", dotnet.workspace_diagnostics, { desc = "[D]ot[n]et [D]iagnostics" })
  end
}
